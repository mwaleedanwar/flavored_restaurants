...
final dark_nopal_dos = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFF697b18),
...
final dark_maa_kitchen = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFFBF1E2E),
  brightness: Brightness.dark,
  scaffoldBackgroundColor: const Color(0xFF2C2C2C),
  cardColor: const Color(0xFF252525),
  backgroundColor: const Color(0xFF343636),
...
final dark_cafe_santorini = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFF8B288C),
  brightness: Brightness.dark,
  scaffoldBackgroundColor: const Color(0xFF2C2C2C),
  cardColor: const Color(0xFF252525),
  backgroundColor: const Color(0xFF343636),
...
final dark_halal_china_box = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFFa60f0f),
  brightness: Brightness.dark,
  scaffoldBackgroundColor: const Color(0xFF2C2C2C),
  cardColor: const Color(0xFF252525),
  backgroundColor: const Color(0xFF343636),
...
final dark_apnaa_bazaar = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFFC42127),
  brightness: Brightness.dark,
  scaffoldBackgroundColor: const Color(0xFF2C2C2C),
  cardColor: const Color(0xFF252525),
  backgroundColor: const Color(0xFF343636),
...
final dark_willy_b_steak_house = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: const Color(0xFF8b0211),
  brightness: Brightness.dark,
  scaffoldBackgroundColor: const Color(0xFF2C2C2C),
  cardColor: const Color(0xFF252525),
  backgroundColor: const Color(0xFF343636),
