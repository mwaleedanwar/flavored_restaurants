...
final ThemeData dark_nopal_dos = ThemeData(
  fontFamily: 'Rubik',
...
final ThemeData dark_maa_kitchen = ThemeData(
  fontFamily: 'Rubik',
...
final ThemeData dark_cafe_santorini = ThemeData(
  fontFamily: 'Rubik',
  primaryColor: Color(0xFF8B288C),
  brightness: Brightness.dark,
