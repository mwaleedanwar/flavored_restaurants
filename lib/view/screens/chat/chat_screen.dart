...
import 'package:noapl_dos_maa_kitchen_flavor_test/view/screens/chat/widget/message_bubble_shimmer.dart';
                              ...
                              child: TextField(
                                ...
                                onSubmitted: (String newText) {
                                  if (newText.trim().isNotEmpty &&
                                      !Provider.of<ChatProvider>(context, listen: false).isSendButtonActive) {
