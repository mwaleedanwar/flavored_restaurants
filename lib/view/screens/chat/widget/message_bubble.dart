                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsets.all(
                                            messages.message != null ? Dimensions.PADDING_SIZE_DEFAULT : 0),
                      ...
                      const SizedBox(),
                      Text(
                        DateConverter.formatDate(DateConverter.isoStringToLocalDate(messages.createdAt), context,
                            isSecond: false),
            ...
            child: (messages.isReply != null && messages.isReply!)
                                    ...
                                    if (messages.reply != null && messages.reply!.isNotEmpty)
                                      Flexible(
                                        child: Container(
                                          ...
                                          child: Padding(
                                            padding: EdgeInsets.all(
                                                messages.reply != null ? Dimensions.PADDING_SIZE_DEFAULT : 0),
                ...
                : Padding(
                    ...
                    child: Container(
                      ...
                      child: Consumer<ProfileProvider>(builder: (context, profileController, _) {
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            Text(
