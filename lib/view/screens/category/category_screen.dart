...
import 'package:noapl_dos_maa_kitchen_flavor_test/view/base/filter_button_widget.dart';
                    ...
                    SliverAppBar(
                      ...
                      leading: ResponsiveHelper.isDesktop(context)
                          ...
                          : Container(
                              ...
                              child: IconButton(
                                  icon: Icon(Icons.chevron_left, color: ColorResources.COLOR_WHITE),
                          ...
                          background: Container(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              imageErrorBuilder: (c, o, s) =>
                                  Image.asset(Images.placeholder_rectangle, fit: BoxFit.cover),
                            ),
                          ),
                        ),
                      ),
                                      ...
                                      ? GridView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            return ResponsiveHelper.isDesktop(context)
                                                ? ProductWidgetWeb(product: category.categoryProductList[index])
                                                : ProductWidget(product: category.categoryProductList[index]);
                                          },
                                        )
                                  ...
                                  : GridView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return ResponsiveHelper.isDesktop(context)
                                            ...
                                            : ProductShimmer(isEnabled: category.categoryProductList == null);
                                      },
                                    ),
                            ),
                          ),
