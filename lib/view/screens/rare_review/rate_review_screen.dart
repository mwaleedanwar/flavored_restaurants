...
import 'package:noapl_dos_maa_kitchen_flavor_test/view/screens/rare_review/widget/product_review_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ResponsiveHelper.isDesktop(context)
          ...
          : CustomAppBar(context: context, title: getTranslated('rate_review', context)),
