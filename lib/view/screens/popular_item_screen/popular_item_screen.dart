          ...
          children: [
            ...
            Expanded(
              child: productProvider.popularProductList != null
                  ? productProvider.popularProductList.length > 0
                      ? RefreshIndicator(
                          onRefresh: () async {
                            _type = 'all';
                            await Provider.of<ProductProvider>(context, listen: false)
                                .getPopularProductList(context, true, '1');
                          },
                                    ...
                                    itemBuilder: (BuildContext context, int index) {
                                      return ResponsiveHelper.isDesktop(context)
                                          ? Padding(
                                              ...
                                              child:
                                                  ProductWidgetWeb(product: productProvider.popularProductList[index]),
                                            )
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ResponsiveHelper.isDesktop(context)
                            ...
                            : ProductShimmer(
                                isEnabled: productProvider.popularProductList == null,
                              );
                      },
                    ),
            ),
