...
class BranchCartView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<BranchProvider>(builder: (context, branchProvider, _) {
      debugPrint('===status:');
      debugPrint('===status:${branchModel.branches.status}');
      return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: branchProvider.selectedBranchId ==
                        branchModel.branches.id
                    ? Border.all(
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          Image.asset(Images.branch_icon,
                              width: 20, height: 20),
                          const SizedBox(
