          ...
          decoration: BoxDecoration(
            border: Border.all(
                color: Theme.of(context)
                    .primaryColor
                    .withOpacity(branchProvider.selectedBranchId == branchesValue.branches.id ? 0.8 : 0.1),
                width: 2),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    if (branchesValue.distance != -1)
                      Column(
                        ...
                        children: [
                          Text(
                            '${(branchesValue.distance * 0.62137119).toStringAsFixed(0)} Miles',
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      height: _size.width < 400 ? 38 : 50,
                      width: _size.width < 400 ? 38 : 50,
                      fit: BoxFit.cover,
                      imageErrorBuilder: (c, o, s) =>
                          Image.asset(Images.placeholder_image, width: _size.width < 400 ? 38 : 50),
                    ),
                  ),
                ),
              ),
