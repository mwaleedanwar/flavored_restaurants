...
import 'package:noapl_dos_maa_kitchen_flavor_test/view/screens/search/widget/filter_widget.dart';
      ...
      body: SafeArea(
        child: Padding(
          padding: EdgeInsets.symmetric(
              horizontal: ResponsiveHelper.isDesktop(context) ? 0 : Dimensions.PADDING_SIZE_DEFAULT),
                  ...
                  child: FilterButtonWidget(
                    ...
                    onSelected: (selected) {
                      ...
                      Provider.of<SearchProvider>(context, listen: false)
                          .searchProduct(_searchController.text, context, type: _type, isUpdate: true);
                    },
                  ),
                ),
                Expanded(
