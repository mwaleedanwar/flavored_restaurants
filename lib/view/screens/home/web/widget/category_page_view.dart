        ...
        itemBuilder: (context, index) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, item) {
                ...
                String _name = '';
                categoryProvider.categoryList[_currentIndex].name.length > 15
                    ? _name = categoryProvider.categoryList[_currentIndex].name.substring(0, 15) + '...'
                    : _name = categoryProvider.categoryList[_currentIndex].name;
                print(
                    '=====image url: ${'${Provider.of<SplashProvider>(context, listen: false).baseUrls.categoryImageUrl}/${categoryProvider.categoryList[_currentIndex].image}'}');
