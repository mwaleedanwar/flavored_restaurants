        ...
        itemBuilder: (context, index) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, item) {
                ...
                String _name = '';
                setMenuProvider.setMenuList[_currentIndex].name.length > 20
                    ? _name = setMenuProvider.setMenuList[_currentIndex].name.substring(0, 20) + ' ...'
                    : _name = setMenuProvider.setMenuList[_currentIndex].name;
                double _startingPrice;
                double _endingPrice;
                if (setMenuProvider.setMenuList[_currentIndex].choiceOptions.length != 0) {
                  List<double> _priceList = [];
                  for (var variation in setMenuProvider.setMenuList[_currentIndex].variations) {
                ...
                double _discount = setMenuProvider.setMenuList[_currentIndex].price -
                    PriceConverter.convertWithDiscount(
                        context,
                        setMenuProvider.setMenuList[_currentIndex].price,
                        setMenuProvider.setMenuList[_currentIndex].discount,
                        setMenuProvider.setMenuList[_currentIndex].discountType);

                bool _isAvailable = DateConverter.isAvailable(
                    setMenuProvider.setMenuList[_currentIndex].availableTimeStarts,
                    setMenuProvider.setMenuList[_currentIndex].availableTimeEnds,
                    context);
                        ...
                        showDialog(
                            ...
                            builder: (con) => Dialog(
                                  child: CartBottomSheet(
                                    product: setMenuProvider.setMenuList[_currentIndex],
                                    fromSetMenu: true,
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: FadeInImage.assetNetwork(
                                        ...
                                        fit: BoxFit.cover,
                                        image:
                                            '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${setMenuProvider.setMenuList[_currentIndex].image}',
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          RatingBar(
                                              rating: setMenuProvider.setMenuList[_currentIndex].rating.length > 0
                                                  ? double.parse(
                                                      setMenuProvider.setMenuList[_currentIndex].rating[0].average)
                                                  : 0.0,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                _discount > 0
                                                    ...
                                                    : SizedBox(),
                                                Text(
                                                  '${PriceConverter.convertPrice(context, _startingPrice, discount: setMenuProvider.setMenuList[_currentIndex].discount, discountType: setMenuProvider.setMenuList[_currentIndex].discountType)}'
                                                  '${_endingPrice != null ? ' - ${PriceConverter.convertPrice(context, _endingPrice, discount: setMenuProvider.setMenuList[_currentIndex].discount, discountType: setMenuProvider.setMenuList[_currentIndex].discountType)}' : ''}',
                                                  style: rubikBold.copyWith(
                                                      fontSize: Dimensions.FONT_SIZE_DEFAULT,
                                          ...
                                          SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                          ElevatedButton(
                                              style: ElevatedButton.styleFrom(primary: F.appbarHeaderColor),
                                              onPressed: () {
                                                showDialog(
                                                    context: context,
                                                    builder: (con) => Dialog(
                                                          child: CartBottomSheet(
                                                            cart: _cartIndex != null
                                                                ? _cartProvider.cartList[_cartIndex]
                                                                : null,
                                                            product: setMenuProvider.setMenuList[_currentIndex],
                                                            fromSetMenu: true,
                                                            callback: (CartModel cartModel) {
