...
import 'package:noapl_dos_maa_kitchen_flavor_test/helper/menu_type.dart';
        ...
        child: Row(
          ...
          children: [
            ...[
              OnHover(
                builder: (isHovered) {
                  final color = isHovered ? F.appbarHeaderColor : menuIconColor;
                  return menu.menuType == MenuType.cart
                      ...
                      : menu.menuType == MenuType.text
                          ? Text(menu.title,
                              style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE, color: color))
                                        ...
                                        ? Consumer<SplashProvider>(
                                            builder: (context, splash, child) => FadeInImage.assetNetwork(
                                                  ...
                                                  imageErrorBuilder: (c, o, s) =>
                                                      Image.asset(F.logo, width: 120, height: 80),
                                                ))
                                        : SizedBox(),
                                  ),
                                )
