...
List<SpecialOfferModel> specialOfferModelFromJson(String str) =>
    List<SpecialOfferModel>.from(json.decode(str).map((x) => SpecialOfferModel.fromJson(x)));

String specialOfferModelToJson(List<SpecialOfferModel> data) =>
...
class SpecialOfferModel {
  ...
  factory SpecialOfferModel.fromJson(Map<String, dynamic> json) => SpecialOfferModel(
        ...
        happyhour: json["happyhour"] != null
            ? List<OfferProduct>.from(json["happyhour"].map((x) => OfferProduct.fromJson(x)))
            : null,
        catering: json["catering"] != null
            ? List<SpecialOfferModel>.from(json["catering"].map((x) => SpecialOfferModel.fromJson(x)))
            : null,
        buffet: json["buffet"] != null
            ? List<SpecialOfferModel>.from(json["buffet"].map((x) => SpecialOfferModel.fromJson(x)))
            : null,
        allItems: json["all_items"] != null
            ? List<OfferProduct>.from(json["all_items"].map((x) => OfferProduct.fromJson(x)))
            : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "happyhour": happyhour != null ? List<dynamic>.from(happyhour!.map((x) => x.toJson())) : null,
        "catering": catering != null ? List<dynamic>.from(catering!.map((x) => x.toJson())) : null,
        "buffet": buffet != null ? List<dynamic>.from(buffet!.map((x) => x.toJson())) : null,
        "all_items": allItems != null ? List<dynamic>.from(allItems!.map((x) => x.toJson())) : null,
...
class OfferProduct {
  ...
  OfferProduct({
    ...
    required this.updatedAt,
    required this.createdAt,
    required this.itemAvailableTimeStarts,
    required this.itemsAvailableTimeEnds,
    required this.days,
  });
